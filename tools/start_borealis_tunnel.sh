...
echo "  npx -y @modelcontextprotocol/mcp-remote http://localhost:${LOCAL_PORT}/mcp"
echo ""
echo "In ~/.claude/settings.json:"
echo "  {\"mcpServers\":{\"borealis\":{\"command\":\"npx\","
echo "    \"args\":[\"-y\",\"@modelcontextprotocol/mcp-remote\","
echo "    \"http://localhost:${LOCAL_PORT}/mcp\"]}}}"
echo ""
echo "==============================================="
echo ""
